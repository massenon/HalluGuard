#!/usr/bin/env bash
# ============================================================
#  HalluGuard — Push Replication Package to GitHub (bash)
# ============================================================
#  Run this script from inside the extracted "halluguard" folder.
#  Replace YOUR-ORG and YOUR-REPO with your actual GitHub account
#  and repository name before executing.
# ============================================================
set -e
